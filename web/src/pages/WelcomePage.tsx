...
export const WelcomePage: React.FC = () => {
  ...
  // Use consistent layout structure for both authenticated and non-authenticated users
  const content = auth.isAuthenticated ? (
    // Authenticated users - compact view
    ...
    // Non-authenticated users - full landing page
  ...
  // Return the content wrapped in a container that works with Layout
  return (
