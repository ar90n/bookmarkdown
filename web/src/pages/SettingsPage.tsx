        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-100">
              <div>
                <label htmlFor="auto-sync" className="text-sm font-medium text-gray-900">
                  Auto-sync
                </label>
                <p className="text-xs text-gray-500">Automatically sync changes to remote</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  checked={bookmark.isAutoSyncEnabled?.() || false}
                  onChange={(e) => bookmark.setAutoSync?.(e.target.checked)}
