...
import { BookmarksPage } from '../../../web/src/pages/BookmarksPage';
import { useBookmarkContext, useDialogContext } from '../../../web/src/contexts/AppProvider';
import { useChromeExtension } from '../../../web/src/hooks/useChromeExtension';
import { useToast } from '../../../web/src/hooks/useToast';
import { useMobile } from '../../../web/src/hooks/useMobile';
import { createRoot } from '../../../web/src/lib/core';

// Mock dependencies
vi.mock('../../../web/src/contexts/AppProvider');
vi.mock('../../../web/src/hooks/useChromeExtension');
vi.mock('../../../web/src/hooks/useToast');
vi.mock('../../../web/src/hooks/useMobile');
vi.mock('../../../web/src/components/dnd', () => ({
...
vi.mock('../../../web/src/components/ui/Toast', () => ({
  Toast: ({ message, onClose }: any) => (
    <div data-testid="toast" onClick={onClose}>{message}</div>
  )
}));
vi.mock('../../../web/src/components/ui/MobileMenu', () => ({
...
vi.mock('../../../web/src/components/ui/MoveModal', () => ({
