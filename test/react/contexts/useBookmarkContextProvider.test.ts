...
import { useBookmarkContextProvider } from '../../../web/src/lib/context/providers/useBookmarkContextProvider';
import { createBookmarkService } from '../../../web/src/lib/adapters/bookmark-service';
import { GistSyncShell } from '../../../web/src/lib/shell/gist-sync';
import { success, failure } from '../../../web/src/lib/types/result';
import { Root, BookmarkInput } from '../../../web/src/lib/types';
import { createRoot } from '../../../web/src/lib/core';

// Mock dependencies
vi.mock('../../../web/src/lib/adapters/bookmark-service');
vi.mock('../../../web/src/lib/shell/gist-sync');
vi.mock('../../../web/src/lib/hooks/useDebounce', () => ({
